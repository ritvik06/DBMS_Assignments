...
\copy batting_style from 'path-to-db/IPL DB/batting_style.csv' delimiter ',' csv header;
\copy bowling_style from 'path-to-db/IPL DB/bowling_style.csv' delimiter ',' csv header;
\copy out_type from 'path-to-db/IPL DB/out_type.csv' delimiter ',' csv header;
\copy outcome from 'path-to-db/IPL DB/outcome.csv' delimiter ',' csv header;
\copy country from 'path-to-db/IPL DB/country.csv' delimiter ',' csv header;
\copy role from 'path-to-db/IPL DB/role.csv' delimiter ',' csv header;
\copy team from 'path-to-db/IPL DB/team.csv' delimiter ',' csv header;
\copy win_by from 'path-to-db/IPL DB/win_by.csv' delimiter ',' csv header;
\copy player from 'path-to-db/IPL DB/player.csv' delimiter ',' csv header;
\copy season from 'path-to-db/IPL DB/season.csv' delimiter ',' csv header;
\copy match from 'path-to-db/IPL DB/match.csv' delimiter ',' csv header;
\copy player_match from 'path-to-db/IPL DB/player_match.csv' delimiter ',' csv header;
\copy ball_by_ball from 'path-to-db/IPL DB/ball_by_ball.csv' delimiter ',' csv header;
\copy batsman_scored from 'path-to-db/IPL DB/batsman_scored.csv' delimiter ',' csv header;
\copy wicket_taken from 'path-to-db/IPL DB/wicket_taken.csv' delimiter ',' csv header;